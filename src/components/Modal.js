...
export default function Modal({children, heading, closer}) {
  function closeHandler() {closer(false)};
  ...
  return (
    <div onClick={modalHandler} className='modal min-h-[250px] cursor-pointer px-4 py-8 flex 
